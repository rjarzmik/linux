...
/* GPS */
#define GPIO_NR_MIOA701_GPS_UART_RXD		(34 | GPIO_ALT_FN_1_IN)
#define GPIO_NR_MIOA701_GPS_UART_CTS		(35 | GPIO_ALT_FN_1_IN)
#define GPIO_NR_MIOA701_GPS_UART_DCD		(36 | GPIO_ALT_FN_1_IN)
#define GPIO_NR_MIOA701_GPS_UART_DSR		(37 | GPIO_ALT_FN_1_IN)
#define GPIO_NR_MIOA701_GPS_UART_TXD		(39 | GPIO_ALT_FN_2_OUT)
#define GPIO_NR_MIOA701_GPS_UART_DTR		(40 | GPIO_ALT_FN_2_OUT)
#define GPIO_NR_MIOA701_GPS_UART_RTS		(41 | GPIO_ALT_FN_2_OUT)

/* GSM */
#define GPIO_NR_MIOA701_GSM_ON			25
#define GPIO_NR_MIOA701_GSM_PREP		(88 | GPIO_OUT)
#define GPIO_NR_MIOA701_GSM_RESET		113
#define GPIO_NR_MIOA701_GSM_UART_RXD		(46 | GPIO_ALT_FN_2_IN)
#define GPIO_NR_MIOA701_GSM_UART_TXD		(47 | GPIO_ALT_FN_1_OUT)
