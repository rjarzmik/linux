...
lcd_hw_init( void )
{
	...
	gpio_set_value(GPIO_NR_HX4700_LCD_SQN, 1);
	gpio_set_value(GPIO_NR_HX4700_LCD_LVDD_3V3_ON, 0);
	gpio_set_value(GPIO_NR_HX4700_LCD_AVDD_3V3_ON, 0);
	gpio_set_value(GPIO_NR_HX4700_LCD_SLIN1, 0);
	gpio_set_value(GPIO_NR_HX4700_LCD_RESET_N, 0);
	mdelay(10);
	gpio_set_value(GPIO_NR_HX4700_LCD_PC1, 0);
	gpio_set_value(GPIO_NR_HX4700_LCD_LVDD_3V3_ON, 0);
	mdelay(20);

	// printk( KERN_NOTICE "LCD init: set values\n" );
	gpio_set_value(GPIO_NR_HX4700_LCD_LVDD_3V3_ON, 1);
	mdelay(5);
	gpio_set_value(GPIO_NR_HX4700_LCD_AVDD_3V3_ON, 1);
	// init w3220 regs?

	mdelay(5);
	gpio_set_value(GPIO_NR_HX4700_LCD_SLIN1, 1);
	mdelay(10);
	gpio_set_value(GPIO_NR_HX4700_LCD_RESET_N, 1);
	mdelay(10);
	gpio_set_value(GPIO_NR_HX4700_LCD_PC1, 1);
	mdelay(10);
	gpio_set_value(GPIO_NR_HX4700_LCD_N2V7_7V3_ON, 1);
}
...
lcd_hw_off( void )
{
	...
	gpio_set_value(GPIO_NR_HX4700_LCD_RESET_N, 0);
	mdelay(10);
	gpio_set_value(GPIO_NR_HX4700_LCD_N2V7_7V3_ON, 0);
	mdelay(10);
	gpio_set_value(GPIO_NR_HX4700_LCD_AVDD_3V3_ON, 0);
	mdelay(10);
	gpio_set_value(GPIO_NR_HX4700_LCD_LVDD_3V3_ON, 0);
