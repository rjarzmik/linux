...
hx4700_bt_configure( int state )
{
	...
	case PXA_UART_CFG_POST_STARTUP:
		...
		gpio_set_value(EGPIO5_BT_3V3_ON, 1);
		gpio_set_value(GPIO_NR_HX4700_CPU_BT_RESET_N, 0);
		mdelay(1);
		gpio_set_value(GPIO_NR_HX4700_CPU_BT_RESET_N, 1);
	...
	case PXA_UART_CFG_PRE_SHUTDOWN:
		gpio_set_value(EGPIO5_BT_3V3_ON, 0);
		mdelay(1);
