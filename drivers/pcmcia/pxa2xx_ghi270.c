...
static int ghi270_pcmcia_hw_init(struct soc_pcmcia_socket *skt)
{
	...
	gpio_direction_output(GHI270_GPIO19_PCMCIA_PRESET1, 0);
	gpio_direction_output(GHI270_GPIO20_PCMCIA_PRESET2, 0);
	gpio_direction_output(GHI270_GPIO37_PCMCIA_nPWR1, 1);
