 ...
 *
 * Copyright 2007 Ian Molton <spyro@f2s.com>
 * Author: Ian Molton
 *
 * Based on wm9712 driver by Liam Girdwood
 *
...
static const u16 wm9705_reg[] = {
	...
	0x0000, 0x0000 // virtual hp mixers  // 0x80
};
...
static const char *wm9705_alc_select[] = {"None", "Left", "Right", "Stereo"};
static const char *wm9705_alc_mux[] = {"Stereo", "Left", "Right", "None"};
static const char *wm9705_out3_src[] = {"Left", "VREF", "Left + Right",
	"Mono"};
static const char *wm9705_spk_src[] = {"Speaker Mix", "Headphone Mix"};
static const char *wm9705_rec_adc[] = {"Stereo", "Left", "Right", "Mute"};
static const char *wm9705_base[] = {"Linear Control", "Adaptive Boost"};
static const char *wm9705_rec_gain[] = {"+1.5dB Steps", "+0.75dB Steps"};
static const char *wm9705_mic[] = {"Mic 1", "Differential", "Mic 2",
	"Stereo"};
static const char *wm9705_rec_sel[] = {"Mic", "CD", "Video", "Aux",
	"Line", "Stereo Mix", "Mono Mix", "Phone"};
static const char *wm9705_ng_type[] = {"Constant Gain", "Mute"};
static const char *wm9705_diff_sel[] = {"Mic", "Line"};

static const struct soc_enum wm9705_enum[] = {
SOC_ENUM_SINGLE(AC97_PCI_SVID, 14, 4, wm9705_alc_select),
SOC_ENUM_SINGLE(AC97_VIDEO, 12, 4, wm9705_alc_mux),
SOC_ENUM_SINGLE(AC97_AUX, 9, 4, wm9705_out3_src),
SOC_ENUM_SINGLE(AC97_AUX, 8, 2, wm9705_spk_src),
SOC_ENUM_SINGLE(AC97_REC_SEL, 12, 4, wm9705_rec_adc),
SOC_ENUM_SINGLE(AC97_MASTER_TONE, 15, 2, wm9705_base),
SOC_ENUM_DOUBLE(AC97_REC_GAIN, 14, 6, 2, wm9705_rec_gain),
SOC_ENUM_SINGLE(AC97_MIC, 5, 4, wm9705_mic),
SOC_ENUM_SINGLE(AC97_REC_SEL, 8, 8, wm9705_rec_sel),
SOC_ENUM_SINGLE(AC97_REC_SEL, 0, 8, wm9705_rec_sel),
SOC_ENUM_SINGLE(AC97_PCI_SVID, 5, 2, wm9705_ng_type),
SOC_ENUM_SINGLE(0x5c, 8, 2, wm9705_diff_sel),
};
...
SOC_ENUM("ALC Function", wm9705_enum[0]),
SOC_SINGLE("ALC Max Volume", AC97_PCI_SVID, 11, 7, 0),
SOC_SINGLE("ALC ZC Timeout", AC97_PCI_SVID, 9, 3, 1),
SOC_SINGLE("ALC ZC Switch", AC97_PCI_SVID, 8, 1, 0),
SOC_SINGLE("ALC NG Switch", AC97_PCI_SVID, 7, 1, 0),
SOC_ENUM("ALC NG Type", wm9705_enum[10]),
...
SOC_ENUM("Bass Control", wm9705_enum[5]),
...
SOC_ENUM("Capture Volume Steps", wm9705_enum[6]),
...
static int wm9705_add_controls(struct snd_soc_codec *codec)
{
	int err, i;

	for (i = 0; i < ARRAY_SIZE(wm9705_snd_ac97_controls); i++) {
		err = snd_ctl_add(codec->card,
				snd_soc_cnew(&wm9705_snd_ac97_controls[i],codec, NULL));
		if (err < 0)
			return err;
	}
	return 0;
...
static const struct snd_kcontrol_new wm9705_hpl_mixer_controls[] = {
...
static const struct snd_kcontrol_new wm9705_hpr_mixer_controls[] = {
...
/* Speaker Mixer */
static const struct snd_kcontrol_new wm9705_speaker_mixer_controls[] = {
...
/* Phone Mixer */
static const struct snd_kcontrol_new wm9705_phone_mixer_controls[] = {
...
/* ALC headphone mux */
static const struct snd_kcontrol_new wm9705_alc_mux_controls =
SOC_DAPM_ENUM("Route", wm9705_enum[1]);

/* out 3 mux */
static const struct snd_kcontrol_new wm9705_out3_mux_controls =
SOC_DAPM_ENUM("Route", wm9705_enum[2]);

/* spk mux */
static const struct snd_kcontrol_new wm9705_spk_mux_controls =
SOC_DAPM_ENUM("Route", wm9705_enum[3]);

/* Capture to Phone mux */
static const struct snd_kcontrol_new wm9705_capture_phone_mux_controls =
SOC_DAPM_ENUM("Route", wm9705_enum[4]);

/* Capture left select */
static const struct snd_kcontrol_new wm9705_capture_selectl_controls =
SOC_DAPM_ENUM("Route", wm9705_enum[8]);

/* Capture right select */
static const struct snd_kcontrol_new wm9705_capture_selectr_controls =
SOC_DAPM_ENUM("Route", wm9705_enum[9]);

/* Mic select */
static const struct snd_kcontrol_new wm9705_mic_src_controls =
SOC_DAPM_ENUM("Route", wm9705_enum[7]);

/* diff select */
static const struct snd_kcontrol_new wm9705_diff_sel_controls =
SOC_DAPM_ENUM("Route", wm9705_enum[11]);

static const struct snd_soc_dapm_widget wm9705_dapm_widgets[] = {
SND_SOC_DAPM_MUX("ALC Sidetone Mux", SND_SOC_NOPM, 0, 0,
	&wm9705_alc_mux_controls),
SND_SOC_DAPM_MUX("Out3 Mux", SND_SOC_NOPM, 0, 0,
	&wm9705_out3_mux_controls),
SND_SOC_DAPM_MUX("Speaker Mux", SND_SOC_NOPM, 0, 0,
	&wm9705_spk_mux_controls),
SND_SOC_DAPM_MUX("Capture Phone Mux", SND_SOC_NOPM, 0, 0,
	&wm9705_capture_phone_mux_controls),
...
SND_SOC_DAPM_MUX("Differential Source", SND_SOC_NOPM, 0, 0,
	&wm9705_diff_sel_controls),
SND_SOC_DAPM_MIXER("AC97 Mixer", SND_SOC_NOPM, 0, 0, NULL, 0),
SND_SOC_DAPM_MIXER_E("Left HP Mixer", AC97_INT_PAGING, 9, 1,
	&wm9705_hpl_mixer_controls[0], ARRAY_SIZE(wm9705_hpl_mixer_controls),
	mixer_event, SND_SOC_DAPM_POST_REG),
SND_SOC_DAPM_MIXER_E("Right HP Mixer", AC97_INT_PAGING, 8, 1,
	&wm9705_hpr_mixer_controls[0], ARRAY_SIZE(wm9705_hpr_mixer_controls),
	 mixer_event, SND_SOC_DAPM_POST_REG),
SND_SOC_DAPM_MIXER("Phone Mixer", AC97_INT_PAGING, 6, 1,
	&wm9705_phone_mixer_controls[0], ARRAY_SIZE(wm9705_phone_mixer_controls)),
SND_SOC_DAPM_MIXER("Speaker Mixer", AC97_INT_PAGING, 7, 1,
	&wm9705_speaker_mixer_controls[0],
	ARRAY_SIZE(wm9705_speaker_mixer_controls)),
...
static int wm9705_add_widgets(struct snd_soc_codec *codec)
{
	...
	for(i = 0; i < ARRAY_SIZE(wm9705_dapm_widgets); i++) {
		snd_soc_dapm_new_control(codec, &wm9705_dapm_widgets[i]);
	}
...
struct snd_soc_codec_dai wm9705_dai[] = {
{
	.name = "AC97 HiFi",
	.playback = {
...
static int wm9705_dapm_event(struct snd_soc_codec *codec, int event)
{
	u16 reg;
...
static int wm9705_reset(struct snd_soc_codec *codec, int try_warm)
{
...
err:
	printk(KERN_ERR "WM9705 AC97 reset failed\n");
	return -EIO;
}
	...
	pm_message_t state)
{
	...
	wm9705_dapm_event(codec, SNDRV_CTL_POWER_D3cold);
	return 0;
}
...
static int wm9705_soc_resume(struct platform_device *pdev)
{
	...
	ret = wm9705_reset(codec, 1);
	if (ret < 0){
		printk(KERN_ERR "could not reset AC97 codec\n");
		return ret;
	}

	wm9705_dapm_event(codec, SNDRV_CTL_POWER_D3hot);
	...
	if (codec->suspend_dapm_state == SNDRV_CTL_POWER_D0)
		wm9705_dapm_event(codec, SNDRV_CTL_POWER_D0);
...
static int wm9705_soc_probe(struct platform_device *pdev)
{
	...
	printk(KERN_INFO "WM9705 SoC Audio Codec %s\n", WM9705_VERSION);
	...
	memcpy(codec->reg_cache, wm9705_reg, sizeof(u16) * ARRAY_SIZE(wm9705_reg));
	...
	codec->dapm_event = wm9705_dapm_event;
